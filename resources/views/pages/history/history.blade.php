                        ...
                        <tr>
                            ...
                            <td>@if( $ord->order_status == 1 )
                                ...
                                @elseif( $ord->order_status == 6 )
                                    <span class="text text-primary">Đã trả hàng</span>
                                @else
                            ...
                            <td>
                                ...
                                @if( $ord->order_status == 5 )
                                    <p><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#trahang">Trả hàng</button></p>
                                @endif
                                @if( $ord->order_status != 3 && $ord->order_status != 4 && $ord->order_status != 5 && $ord->order_status != 6 && $ord->order_status != 2)
                                ...
                                <div id="huydon" class="modal fade" role="dialog">
                                    ...
                                    <div id="trahang" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            <form>
                                                @csrf
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="modal-title">Lí do trả hàng </h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <p><textarea rows="5" class="lydotrahang" required placeholder="Lý do trả hàng..."></textarea></p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button
                                                            type="button"
                                                            style="background-color: red; color: white; padding: 10px 20px; border: none; border-radius: 5px;"
                                                            id="{{ $ord->order_code }}"
                                                            onclick="Tradonhang('{{ $ord->order_code }}')">
                                                            Trả đơn hàng
                                                        </button>
